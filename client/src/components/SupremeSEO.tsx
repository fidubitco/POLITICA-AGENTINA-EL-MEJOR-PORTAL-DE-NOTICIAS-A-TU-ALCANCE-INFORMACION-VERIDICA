...
export const SupremeSEO: React.FC<SupremeSEOProps> = ({
  ...
  const safeTitle = title || 'Política Argentina';
  const safeDescription = description || 'Portal profesional de noticias políticas de Argentina';
  const safeUrl = url || 'https://politicaargentina.com/';
  const safeImage = image || 'https://politicaargentina.com/og-image.jpg';
